(ns net.vinceturner.CljActorMapper
  (:gen-class
    :name net.vinceturner.CljActorMapper
...
(defn -map [this key value context]
  ;; (println "CljActorMapper->map: entered the function baby")
  ;; (prn "CljActorMapper->map: value=" value)
  ...
  ;; (println "CljActorMapper->-map: done with let, done with sub")
  )
